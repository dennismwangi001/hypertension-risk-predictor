...
# Custom CSS for better readability on dark mode
st.markdown("""
<style>
    .main {
...
# The exact safe features the model expects (in this exact order)
safe_features = [
...
# ✅ FIXED: Using a reliable, high-quality medical image from Unsplash
...
st.sidebar.image(sidebar_image_url, use_container_width=True, caption="AI-Powered Health")
...
if page == " Dashboard":
    ...
    # ✅ FIXED: Using a reliable, high-quality banner image from Unsplash
    ...
    if submit_button:
        if not models:
            ...
            try:
                ...
                st.error("Feature mismatch error. Please ensure your training script and app use the same feature list.")
                st.stop()
    ...
    st.title("️ About the Model & Data")
